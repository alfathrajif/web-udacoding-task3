    ...
    >
      ...
      <div className="p-3">
        ...
        <ul className="text-gray-400 text-sm">
          {(() => {
            if (product.stock === "Pre-Order") {
              ...
              return <li>Stok: {product.stock}</li>;
            }
          })()}
        </ul>
        <div className="my-3">
          <div className="text-sm font-medium">{product.discountAmount}</div>
        ...
        <div className="flex gap-1 mb-1">
          ...
          <div className="text-xs font-medium ml-0.5">{product.rating}</div>
        </div>
        <div className="flex gap-1">
          <div className="text-xs font-medium mb-0.5">
            Terjual : {product.soldOut}
          </div>
          <div className="text-xs font-bold">|</div>
